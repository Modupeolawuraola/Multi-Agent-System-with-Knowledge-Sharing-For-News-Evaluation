...
if __name__ == '__main__':
    ...
    # )
    add_bias_to_json(
        news_json_path='merged_news3-10_3-17.json',
        allsides_csv_file='https://raw.githubusercontent.com/Modupeolawuraola/Multi-Agent-System-with-Knowledge-Sharing-For-News-Evaluation/refs/heads/pc/AllSides%20Media%20Bias%20Ratings%203.11.25.csv?token=GHSAT0AAAAAAC5K326KRASD5JX6TJDYMYY6Z6Y6XIQ',
        output_json_path='../KG-Builder/all_articles_with_bias_test.json'
    )
