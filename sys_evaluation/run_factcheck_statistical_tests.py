"""
Run statistical tests for fact-checking comparison
"""
import pandas as pd
...
print("="*60)
print("FACT-CHECKING - STATISTICAL SIGNIFICANCE TESTING")
print("="*60)
...
print(f"\nTest set size: {len(y_true)} claims")
...
print("\n" + "="*60)
print("✅ ALL FACT-CHECKING TESTS COMPLETE!")
print("="*60)